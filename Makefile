...
am__append_7 = src/x86/ffi.c src/x86/win64.S
subdir = .
...
am__objects_7 = src/x86/ffi.lo src/x86/win64.lo
...
ACLOCAL = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/missing aclocal-1.13
ALLOCA = 
AMTAR = $${TAR-tar}
...
AM_RUNTESTFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/missing autoconf
AUTOHEADER = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/missing autoheader
AUTOMAKE = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/missing automake-1.13
AWK = gawk
CC = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/msvcc.sh -m64
CCAS = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/msvcc.sh -m64
CCASDEPMODE = depmode=msvc7
CCASFLAGS = -O2
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/missing makeinfo
MANIFEST_TOOL = mt
...
TARGETDIR = x86
VERSION = 3.2.1
abs_builddir = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/x86_64-unknown-cygwin
abs_srcdir = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/x86_64-unknown-cygwin/..
abs_top_builddir = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/x86_64-unknown-cygwin
abs_top_srcdir = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/x86_64-unknown-cygwin/..
ac_ct_AR = ar
ac_ct_CC = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/msvcc.sh -m64
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/install-sh
...
pdfdir = ${docdir}
prefix = /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/install
...
all all-all:
	@ HOST="$(HOST)" \
	; test ".$$HOST" = "." && HOST=` sh /cygdrive/f/workspace/vs14/x64/libffi-3.2.1/config.guess ` \
